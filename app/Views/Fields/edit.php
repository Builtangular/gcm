                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="settings-form">
                                            <form action="<?php echo base_url(); ?>fields/edit" method="post">
                                                ...
                                                <div class="profile-details">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="col-form-label mb-2"> Status <span
                                                                    class="text-danger">*</span> </label><br>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="status"
                                                                    id="inlineRadio1" value="Active"
                                                                    <?= $fields_data['status'] === 'Active' ? 'checked' : '' ?>>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="status"
                                                                    ...
                                                                    <?= $fields_data['status'] === 'Inactive' ? 'checked' : '' ?>>
                                                                <label class="form-check-label"
                                                ...
                                                <div class="submit-button">
                                                    <input type="submit" name="add_fuel_type" class="btn btn-primary"
                                                        value="Save Changes">
