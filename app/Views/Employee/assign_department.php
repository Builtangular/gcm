                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-wrap">
                                                            ...
                                                            <select class="select" id="department_id"
                                                                ...
                                                                <option value="<?= $row["id"] ?>"
                                                                    <?= ($selected == $row["id"]  ? 'selected' : set_select('department_id', $row['id']) ) ?>>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" required name="start_date"
                                                            value="<?= $start_date ?>" min="<?= $start_date ?>"
                                                            class="form-control">
                                                        <?php
                                                    ...
                                                    <div class="col-md-12">
                                                        <label class="col-form-label" style="padding-right: 10px;">
                                                            Authorize for Payment<span class="text-danger">*</span>
                                                        </label>
                                                        <input type="radio" name="payment_authority"
                                                            id="payment_authority" value="1"
                                                            <?= isset($emp_data) && $emp_data['payment_authority'] == '1' ? 'checked' : '' ?>>
                                                        <label for="payment_authority"
                                                            style="padding-right:15px">Yes</label>
                                                        <input type="radio" name="payment_authority"
                                                            id="payment_authority" value="0"
                                                            <?= isset($emp_data) && $emp_data['payment_authority'] == '0' ? 'checked' : '' ?>>
                                                        <label for="payment_authority"
                                                            style="padding-right:15px">No</label>
                                                        <!-- ./ Payment Authority Flag -->
