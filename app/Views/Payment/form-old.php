                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="form-wrap col-md-12">
                                                        ...
                                                        <input type="radio" name="payment_type" id="payment_type_id"
														 onchange="displayDivs()" value="<?= $val['id'] ?>"
                                                            required>
                                                        <label for="<?= $val['name'] ?>" style="padding-right:15px"><?= $val['name'] ?></label>
                                                        <?php } ?>  
														<?php
													...
													<div class="col-md-6 payment_types_fuel_urea_html driver_div"
                                                        hidden>
                                                        <div class="form-wrap">
                                                            <label class="col-form-label">
                                                                Vehicle<span
                                                                    class="text-danger payment_types_fuel_urea_html"
                                                                    hidden>*</span>
                                                            </label>
                                                            <select
                                                                class="form-class select2 payment_types_fuel_urea_inpt"
                                                                id="vehicle_id" name="vehicle_id"
                                                                onchange="duplicateVehicle('vehicle_id','transfer_from_vehicle_id');getSameTypesVehicles();">
                                                                <option value="">Select Vehicle</option>
                                                            </select>
                                                            <span class="text-danger duplicate_vehicle_spn"
                                                                id="vehicle_id_spn" hidden>Vehicle No. is duplicate,
                                                                please select another vehicle</span>
                                                            <?php
                                                    ...
                                                    <div class="col-md-6 fuel_fill_type_html" hidden>
                                                        <div class="form-wrap">
                                                            <label class="col-form-label">
                                                                Fuel Fill Type<span
                                                                    class="text-danger fuel_fill_type_html"
                                                                    hidden>*</span>
                                                            </label>
                                                            <select class="form-class select2 fuel_fill_type_inpt"
                                                                id="fuel_fill_type" name="fuel_fill_type"
                                                                onchange="displayFuelType()">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="col-md-6 fuel_fill_type_transfer" hidden>
                                                        <div class="form-wrap">
                                                            <label class="col-form-label">
                                                                Transfer From Vehicle<span
                                                                    class="text-danger fuel_fill_type_transfer"
                                                                    hidden>*</span>
                                                            </label>
                                                            <select class="form-class select2"
                                                                id="transfer_from_vehicle_id"
                                                                name="transfer_from_vehicle_id"
                                                                onchange="duplicateVehicle('transfer_from_vehicle_id','vehicle_id')">
                                                                <option value="">Select</option>
                                                            </select>
                                                            <span class="text-danger duplicate_vehicle_spn"
                                                                id="transfer_from_vehicle_id_spn" hidden>Vehicle No. is
                                                                duplicate, please select another vehicle</span>
                                                            <?php
                                                    ...
                                                    <div class="col-md-6 fuel_fill_type_pump" hidden>
                                                        <div class="form-wrap">
                                                            <label class="col-form-label">
                                                                Fuel Pump Brand<span
                                                                    class="text-danger fuel_fill_type_pump"
                                                                    hidden>*</span>
                                                            </label>
                                                            <select class="form-class select2" id="fuel_pump_brand_id"
                                                                name="fuel_pump_brand_id">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="col-md-6 urea_html" hidden>
                                                        <div class="form-wrap">
                                                            <label class="col-form-label">
                                                                Vendor<span class="text-danger urea_html"
                                                                    hidden>*</span>
                                                            </label>
                                                            <select class="form-class select2 urea_inpt" id="vendor_id"
                                                                name="vendor_id">
                                                                <option value="">Select</option>
                                                                <?php foreach($vendors as $val){?>
                                                                <option value="<?= $val['id'] ?>">
                                                                    <?= $val['party_name'] ?></option>
                                                                <?php }?>
                                                            </select>
                                                        </div>
                                                        <?php
                                                    ...
                                                    <div class="col-md-6 payment_types_fuel_urea_html" hidden>
                                                        ...
                                                        <input type="number" step="0.01" name="quantity" id="quantity"
                                                            class="form-control payment_types_fuel_urea_inpt">
                                                        <?php
                                                    ...
                                                    <div class="col-md-6 payment_types_fuel_urea_html" hidden>
                                                        <label class="col-form-label">KM Reading<span
                                                                class="text-danger payment_types_fuel_urea_html"
                                                                hidden>*</span></label>
                                                        <input type="number" step="0.01" name="km_reading"
                                                            id="km_reading"
                                                            class="form-control payment_types_fuel_urea_inpt">
                                                        <?php
                                                    ...
                                                    <div class="col-md-6 money_html" hidden>
                                                        ...
                                                        <input type="number" step="0.01" name="adavanced_payment"
                                                            id="adavanced_payment" class="form-control money_inpt">
                                                    </div>
                                                    ...
                                                    <!-- <div class="col-md-6">
                                                        <div class="form-wrap">
                                                            ...
                                                            <select class="form-class select2" id="payment_mode"
                                                                name="payment_mode" onchange="displayPaymentMode()">
                                                                <option value="">Select</option>
                                                                <?php if($payment_modes) { foreach($payment_modes as $payment_mode){ ?>
                                                                <option value="<?= $payment_mode['id']?>"
                                                                    validinpt="<?= strtolower($payment_mode['name']) ?>">
                                                                    <?= ucfirst($payment_mode['name']) ?></option>
                                                                <?php } }?>
                                                            </select>
                                                            <?php
                                                    ...
                                                    <div class="col-md-6 form-wrap card_html payment_mode" hidden>
                                                        <label class="col-form-label">Card Number<span
                                                                class="text-danger card_html" hidden>*</span></label>
                                                        <input type="number" maxlength="20" name="card_no"
                                                            autocomplete="off" id="card_no"
                                                            class="form-control card_inpt">
                                                        <?php
                                                    ...
                                                    <div class="col-md-6 form-wrap upi_html payment_mode" hidden>
                                                        <label class="col-form-label">UPI Number<span
                                                                class="text-danger upi_html" hidden>*</span></label>
                                                        <input type="text" maxlength="30" name="upi_no"
                                                            autocomplete="off" id="upi_no" class="form-control upi_inpt"
                                                            onchange="isValid_UPI_ID()" placeholder="test@PNB">
                                                        <span class="text-danger upi_err" hidden>Please enter valid
                                                            upi</span>
                                                        <?php
                                                    ...
                                                    <div class="col-md-6 form-wrap account_html payment_mode" hidden>
                                                        <label class="col-form-label">Account Number<span
                                                                class="text-danger upi_html" hidden>*</span></label>
                                                        <input type="number" maxlength="30" name="account_no"
                                                            autocomplete="off" id="account_no"
                                                            class="form-control account_inpt">
                                                        <?php
                                                    ...
                                                    <input type="hidden" name="transaction_no" id="transaction_no"
                                                        value="" />
                                                </div>
                                            </div>
