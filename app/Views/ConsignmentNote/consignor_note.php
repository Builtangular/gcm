    ...
    <tbody>
        ...
        <tr style="height:21pt">
            ...
            <td class="td16" colspan="3">
                <p class="s9 p14 txt-center" >Driver Name : <?= isset($lr['driver']['driver_name']) && ($lr['driver']['driver_name']) ? ucwords(strtolower($lr['driver']['driver_name'])) : '-' ?></p>
                <p class="s9 p14 txt-center" >Driver Phone No : <?= isset($lr['driver']['primary_phone']) && ($lr['driver']['primary_phone']) ? $lr['driver']['primary_phone'] : '-' ?></p>
            </td> 
        </tr>
